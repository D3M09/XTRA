...
try:
	...
	print ('\n\t\x1b[0m >_< Loading Please Wait... >_<\n')
...
try:
	...
	catet_futur = ('# • Installing futures •')
...
try:
	...
	catet_mek = ('# • Installing mechanize •')
...
try:
	...
	catet_mask = ('# • Installing stdiomask •')
...
bff_2.close()
if my_music !=0:
	catet_play = ('# • Installing Audio Player•')
